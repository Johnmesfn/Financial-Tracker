...
const Dashboard = () => {
  ...
  const [expenseCategories, setExpenseCategories] = useState([]); // Renamed from categories
  ...
  const fetchDashboardData = async () => {
    ...
    try {
      const [
        ...
        axios.get(
          "http://localhost:5000/api/entries/category-breakdown?type=expense"
        ),
        axios.get(
          "http://localhost:5000/api/entries/category-breakdown?type=income"
        ),
  ...
  return (
    ...
    >
      ...
      <StatsGrid>
        <StatCard $gradient="linear-gradient(90deg, #10b981, #059669)">
          ...
          <StatInfo>
            ...
            <StatValue>{formatCurrency(summary.income)}</StatValue>
          </StatInfo>
        </StatCard>
        <StatCard $gradient="linear-gradient(90deg, #ef4444, #dc2626)">
          ...
          <StatInfo>
            ...
            <StatValue>{formatCurrency(summary.expense)}</StatValue>
          </StatInfo>
        </StatCard>
      ...
      {/* NEW GRID FOR CATEGORY BREAKDOWNS SIDE BY SIDE */}
      <ContentGrid>
